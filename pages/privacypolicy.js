...
export default function PrivacyPolicy() {
  return (
    <main style={{ width: "90%", margin: "auto" }}>
      <h1 className="text-center text-uppercase p-5">Privacy Policy </h1>
      <h4>
      ...
      <p>
        ...
        the meaning given to it in the Act. In general terms, it is any
      ...
      <p>
        We may collect your name, mailing or street address, email address,
        telephone number, facsimile number, profession, occupation or job title
        and any additional information relating to you that you provide to us
        directly through our websites or indirectly through use of our websites
        or online presence, through our representatives or otherwise and
        information you provide to us through customer surveys or visits. We may
      ...
      <h2>Cookies </h2>
      <p>
        When you access our website, we may send a “cookie” (which is a small
        summary file containing a unique ID number) to your computer. This
        enables us to recognize your computer. It also enables us to keep track
      ...
      <p>
        ...
        business activities and functions and to provide best possible quality
        of customer service. We collect, hold, use and disclose your personal
      ...
      <h2>How can you access and correct your personal information? </h2>
      <p>
        You may request access to any personal information we hold about you at
        any time by contacting us (see the details below). Where we hold
        information that you are entitled to access, we will try to provide you
        with suitable means of accessing it (for example, by mailing or emailing
        it to you). We may charge you a fee to cover our administrative and
        other reasonable costs in providing the information to you and, if so,
        the fees will be disclosed on our website. We will not charge for simply
        making the request and will not charge for making any corrections to
        your personal information. There may be instances where we cannot grant
      ...
      <h2>Contacting us </h2>
      <p>
        If you have any questions about this privacy policy, any concerns or
        feedback regarding the treatment of your privacy, please use the contact
        link on our website or email to support@commerciallistingspro.com. We
        will treat your requests or complaints confidentially. Our
